...
\newcommand{\thesistitle}{Comparison of LOD Frameworks} % The title of the thesis. The English version should be used, if it exists.
\newcommand{\thesissubtitle}{Finding evaluation of existing frameworks} % The subtitle of the thesis. The English version should be used, if it exists.
...
\input{parts/4_overview.tex}
\input{parts/5_criteria.tex}
\input{parts/6_comparison.tex}
\input{parts/7_tuwien.tex}
\input{parts/8_summary.tex}
