...
\newcommand{\thesissubtitle}{Comparing LD solutions and giving a guide to use the framework as guide at TU Wien} % The subtitle of the thesis. The English version should be used, if it exists.
