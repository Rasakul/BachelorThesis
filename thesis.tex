...
\setdate{10}{07}{2016} % Set date with 3 arguments: {day}{month}{year}.
\settitle{\thesistitle}{\thesistitle} % Sets English and German version of the title (both can be English or German).
\setsubtitle{Finding evaluation and application of implicit existing best practise frameworks}{Finding evaluation and application of implicit existing best practise frameworks} % Sets English and German version of the subtitle (both can be English or German).
...
%\addstatementpage %TODO: add

%\input{parts/0_1_acknowledgements.tex}
\input{parts/0_2_abstract.tex}
...
\input{parts/2_existing.tex}
\input{parts/3_methodology.tex}
\input{parts/4_comparison.tex}
\input{parts/5_implementation.tex}
\input{parts/6_reflection.tex}
\input{parts/7_summary.tex}
