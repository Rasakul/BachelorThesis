...
\textbf{Presentation layer} & \begin{tabular}[c]{@{}l@{}}A solution which only covers the presentation or \\ UI layer and therefore depends on other component.  \\ Managing how LOD can be accessed from outside \\ and how the data are exposed.\end{tabular} \\ \hline
\textbf{Business Layer}     & \begin{tabular}[c]{@{}l@{}}A solution which only covers the business layer \\ and therefore depends on other components. \\ Managing how LOD are processed.\end{tabular}                                                          \\ \hline
\textbf{Data Access Layer}  & \begin{tabular}[c]{@{}l@{}}A solution which only covers the data access layer \\ and therefore depends on other components. \\ Managing how LOD are stored and accessed \\ by the application.\end{tabular}                          \\ \hline
\end{tabular}
\label{tbl_classification_def}
