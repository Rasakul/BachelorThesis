...
\section{Frameworks}
\subsection{Euclid Project}\index{Euclid Project!Frameworks}
\url{http://www.euclid-project.eu/modules/chapter5}
\subsection{LUCERO}\index{LUCERO!Frameworks}
\url{https://code.google.com/archive/p/luceroproject/wikis/StepByStepDocumentation.wiki}
\subsection{LD-Patterns}\index{LD-Patterns!Frameworks}
\url{http://patterns.dataincubator.org/book/linked-data-patterns.pdf }
\subsection{Linked Data: Evolving the Web into a Global Data Space (Heath, Bizer)}\index{Linked Data Book!Frameworks}
\url{http://linkeddatabook.com/editions/1.0/#htoc61}
\section{All-In-One Solutions}
\subsection{D2R Server}\index{D2R Server!All-In-One Solutions}
\url{http://d2rq.org/d2r-server}
\section{Excluded Tools}\index{LOD2 Stack!Tools}
\subsection{LOD2 Stack}
(too general, only stack of technologies)
\url{http://stack.linkeddata.org/lod2/}
\subsection{LODUM}\index{LODUM!Other LOD Projects}
